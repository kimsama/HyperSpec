...
Parse arguments: `<file> --locale <code>` (e.g., `htmls/00.Architecture.html --locale ko`)

## Workflow

1. Read the source HTML file from `docs/html/htmls/`
...
6. Save to `docs/html/htmls/<locale>/<filename>.html`
7. Add the translation to the `docs/html/index.html` sidebar under the Translations section
8. Run `hyperspec index` to update manifest with translation mapping
