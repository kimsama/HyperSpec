...
<script src="../assets/annotate.js"></script>
    ...
    writeFileSync(join(tempDir, "docs", "html", "htmls", "e2e-test.html"), htmlContent);
    await runIndex(tempDir);

    const manifest = JSON.parse(readFileSync(join(tempDir, "docs", "html", "manifest.json"), "utf-8"));
...
{"title":"Test Doc","category":"spec","tags":["test"],"created":"2026-05-25","updated":"2026-05-25","locale":"en","version":1}
    ...
    writeFileSync(join(tempDir, "docs", "html", "htmls", "test-doc.html"), enHtml);
    writeFileSync(join(tempDir, "docs", "html", "htmls", "ko", "test-doc.html"), koHtml);
  ...
  it("annotation assets are present after init", async () => {
    await runInit(tempDir);
    const assetsDir = join(tempDir, "docs", "html", "assets");
